...
### UPDATE: I've since moved to gulp as my build tool of choice and highly recommend using it over Grunt. I've rewritten this post for gulp [here](http://www.mikeobrien.net/blog/using-gulp-to-build-and-deploy-dotnet-apps-on-windows/). ###
